            ...
            : Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Total Sales Invoice : ${dataDisplayHead[0]['Filtered']}',
                      style: const TextStyle(
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          'Cash:${dataDisplayHead[0]['CashReceived'].toStringAsFixed(2)}',
                          style: const TextStyle(
                              fontSize: 18, fontWeight: FontWeight.w600),
                        ),
                        Text(
                          'Bank:${dataDisplayHead[0]['BankAmount'].toStringAsFixed(2)}',
                          style: const TextStyle(
                              fontSize: 18, fontWeight: FontWeight.w600),
                        ),
                      ],
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          'Total : ${dataDisplayHead[0]['GrandTotal'].toStringAsFixed(2)}',
                          style: const TextStyle(
                              fontSize: 20, fontWeight: FontWeight.w600),
                        ),
                        Text(
                          'Balance:${dataDisplayHead[0]['Balance'].toStringAsFixed(2)}',
                          style: const TextStyle(
                              fontSize: 18, fontWeight: FontWeight.w600),
                        ),
                      ],
                ...
                return InkWell(
                  onTap: () {
                    ...
                    SalesType sData = salesTypeDataList
                        .where((element) => element.id == refId)
                        .first;
                    salesTypeData = SalesType(
                        ...
                        sColor: sData.sColor,
                        tax: sData.tax);
                    showDetails(context, dataDisplay[index], refId);
                  },
                  child: Center(
                    child: Padding(
