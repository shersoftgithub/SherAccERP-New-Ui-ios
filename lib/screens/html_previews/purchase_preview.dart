...
class _PurchasePreviewShowState extends State<PurchasePreviewShow> {
  ...
  previewWidget(header) {
    ...
    var invoiceHead = header == 'Purchase'
        ? Settings.getValue<String>('key-purchase-invoice-head',
            defaultValue: 'PURCHASE')
        : header == 'PurchaseOrder'
            ? Settings.getValue<String>('key-purchase-order-head',
...
_buildEstimateHeader(
  ...
  return pw.Column(children: [
    ...
    pw.Container(
      ...
      height: 30,
      decoration: pw.BoxDecoration(
          color: const PdfColor.fromInt(0xFFCCCCCC), border: pw.Border.all()),
      child: pw.Center(
          child: pw.Text(
        "ESTIMATE",
